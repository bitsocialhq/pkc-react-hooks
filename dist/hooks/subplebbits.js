...
const useSubplebbitsStatsStore = createStore((setState) => ({
    subplebbitsStats: {},
    setSubplebbitStats: (subplebbitAddress, subplebbitStats) => setState((state) => ({
        subplebbitsStats: Object.assign(Object.assign({}, state.subplebbitsStats), { [subplebbitAddress]: subplebbitStats }),
    })),
}));
/**
